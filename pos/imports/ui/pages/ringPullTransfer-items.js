...
// Declare template
var itemsTmpl = Template.Pos_ringPullTransferItems,
    actionItemsTmpl = Template.Pos_ringPullTransferItemsAction;
editItemsTmpl = Template.Pos_ringPullTransferItemsEdit;
...
// Local collection
var itemsCollection;
export const deletedItem = new Mongo.Collection(null); //export collection deletedItem to ringPullTransfer js
...
// Page
import './ringPullTransfer-items.html';
    ...
    tableSettings: function () {
        ...
        reactiveTableSettings.fields = [{
            ...
            headerClass: function () {
                let css = 'text-center col-action-ringPullTransfer-item';
                return css;
            },
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('pos.ringPullTransfer.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        event.preventDefault();
        let itemDoc = this;
        if (AutoForm.getFormId() == "Pos_ringPullTransferUpdate") { //check if update form
            swal({
                    title: "Are you sure?",
                    text: "លុបទំនិញមួយនេះ?",
            ...
            destroyAction(
                itemsCollection, {
                    ...
                    title: TAPi18n.__('pos.ringPullTransfer.schema.itemId.label'),
...
AutoForm.addHooks(['Pos_ringPullTransferItemsEdit'], hooksObject);
