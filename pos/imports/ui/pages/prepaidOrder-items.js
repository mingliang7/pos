...
// Declare template
var itemsTmpl = Template.Pos_prepaidOrderItems,
    actionItemsTmpl = Template.Pos_prepaidOrderItemsAction;
editItemsTmpl = Template.Pos_prepaidOrderItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'pos.prepaidOrder.schema';
        ...
        reactiveTableSettings.fields = [{
            ...
            headerClass: function () {
                let css = 'text-center col-action-prepaidOrder-item';
                return css;
            },
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('pos.prepaidOrder.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('pos.prepaidOrder.schema.itemId.label'),
...
AutoForm.addHooks(['Pos_prepaidOrderItemsEdit'], hooksObject);
