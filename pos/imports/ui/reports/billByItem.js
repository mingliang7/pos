...
invoiceDataTmpl.helpers({
    ...
    getTotal(total, customerName){
        ...
        string += `<td><u>Total ${_.capitalize(customerName)}:</u></td><td><u>${numeral(total).format('0,0.0000')}</u></td>`;
        return string;
    },
    getTotalFooter(totalQty, total, n){
        ...
        string += `<td><b>Total:</td></b><td><b>${numeral(totalQty).format('0,0')}</b></td><td></td><td><b>${numeral(total).format('0,0.0000')}$</b></td>`;
        return string;
    },
