...
invoiceDataTmpl.helpers({
    ...
    getTotal(dueAmount, paidAmount, total, customerName){
        ...
        string += `<td><u>Total ${_.capitalize(customerName)}:</u></td><td><u>${numeral(dueAmount).format('0,0.0000')}</u></td><td><u>${numeral(paidAmount).format('0,0.0000')}</u></td><td><u>${numeral(total).format('0,0.0000')}</u></td>`;
        return string;
    },
